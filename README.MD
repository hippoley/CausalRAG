...
### A causal decision runtime for AI agents that must act under uncertainty.
...
<sub>Runtime package / CLI: <code>branchpoint</code>. Branchpoint is the execution engine inside CausalRAG, not a separate project.</sub>
